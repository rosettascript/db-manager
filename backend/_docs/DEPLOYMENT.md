...
For development setup instructions, see **[_docs/SETUP_GUIDE.md](../../_docs/SETUP_GUIDE.md)**.

This guide focuses on production deployment. For development, use:
```bash
cd backend
npm install
cp env.template .env
# Edit .env (see ../../_docs/SETUP_GUIDE.md)
npm run start:dev
```
